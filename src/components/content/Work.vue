  ...
  <div class="left-side">
   <div class="side-wrapper">
    ...
    <div class="side-menu">
     ...
     <!--a :class="category == 'Chrome Extensions' && 'category-active'" @click="handleCategoryClick('Chrome Extensions')" href="#">
      <div class="item-left">
        <svg viewBox="0 0 512 512" fill="currentColor">
        <path d="M0 331v112.295a14.996 14.996 0 007.559 13.023L106 512V391L0 331zM136 391v121l105-60V331zM271 331v121l105 60V391zM406 391v121l98.441-55.682A14.995 14.995 0 00512 443.296V331l-106 60zM391 241l-115.754 57.876L391 365.026l116.754-66.15zM262.709 1.583a15.006 15.006 0 00-13.418 0L140.246 57.876 256 124.026l115.754-66.151L262.709 1.583zM136 90v124.955l105 52.5V150zM121 241L4.246 298.876 121 365.026l115.754-66.15zM271 150v117.455l105-52.5V90z" />
        </svg>
   ...
   <div class="side-wrapper">
    ...
    <div class="side-menu">
     <a :class="category == 'Logo' && 'category-active'" @click="handleCategoryClick('Logo')" href="#">
      <div class="item-left">
        <svg viewBox="0 0 512 512" fill="currentColor">
        ...
        return {
            ...
            projects: [
                ...
                },
                {
                    ...
                    stack: ['Figma', 'CSS'],
                    bg: require('@/content/logo/podular.us/podular_animated_banner.gif'),
                    category: 'Logo',
                },
                {
                    title: 'Hidden Gems Consulting',
                    subtitle: 'Manufacturing, operations, and talent sourcing consultancy',
                    stack: ['Figma'],
                    bg: require('@/content/logo/HGC/thumb.png'),
                    category: 'Logo',
                },
                {
                    title: 'Playground',
                ...
                },
                {
                    ...
                    stack: ['Figma'],
                    bg: require('@/content/typeface/podular.us/banner.png'),
                    category: 'Typography'
                },
                /*{
